  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        secondary: "#A78BFA", // Lilac
        accent: "#60A5FA", // Sky blue
        "lavender-gray": "#F8F7FF", // Very light purple-gray background
        "deep-indigo": "#312E81", // Deep indigo text
        stroke: "#E6EBF1",
        "stroke-dark": "#27303E",
        dark: {
          DEFAULT: "#111928",
      ...
      backgroundImage: {
        ...
        "gradient-magic": "linear-gradient(135deg, #F8F7FF 0%, #EDE9FE 25%, #E0E7FF 75%, #F8F7FF 100%)",
        "gradient-glow": "radial-gradient(ellipse at top left, #A78BFA20 0%, transparent 50%), radial-gradient(ellipse at bottom right, #60A5FA20 0%, transparent 50%)",
